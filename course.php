                ...
                <div class="col-12">
                    <div class="section-heading">
						<?php
								...
								echo"<center>";
								echo "<center><a href='addcourse.php?lecturerid=".$lecturerid."&role=".$role."'><button>Add New Course</button></a></center></br>";
								...
								$course = $xml->xpath('/courses/course[lecturerid="' . "$lecturerid" . '"]');
